...
<html lang="en">
  ...
  <body>
          ...
          <div class="content-wrapper">
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Tambah Pengiriman Cabang</h4>
                </div>
              </div>
              <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col">
                  <select class="selectpicker form-control" data-live-search="true" id="noresi" placeholder="Pilih No Resi">
                    ...
                    <?php } ?>
						    ...
						    <div class="col">
						    	<select class="form-control" id="cabang" data-live-search="true" placeholder="Pilih Cabang">
                    ...
                    <?php foreach ($cabang['data'] as $data) {?>
                      ...
                      <?php } ?>
						  ...
						  <div class="row" style="padding-top: 5px">
						    <div class="col">
                  <select class="form-control" id="kurir" data-live-search="true" placeholder="Pilih Kurir">
                    ...
                    <?php foreach ($kurir['data'] as $kurir) {?>
                      ...
                      <?php } ?>
						    ...
						    <div class="col">
						      <input type="text" class="form-control" placeholder="Alamat Transit" id="alamat">
						    </div>
						  </div>
              <div class="row" style="padding-top: 5px">
                <div class="col">
              ...
              <div class="row" style="padding-top: 5px">
                ...
                <div class="col">
                  <input type="text" class="form-control" placeholder="Alamat Penerima" id="alamatpenerima">
                </div>
						    <div class="col">
    ...
    <?php $this->load->view('pengirimanCabang/js/tambah_js')?>
</html>