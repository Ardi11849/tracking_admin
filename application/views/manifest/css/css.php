...
<title>Konfirmasi Pengiriman Cabang</title>
<link rel="stylesheet" href="<?php echo base_url()?>template/DataTables/datatables.min.css">
<link rel="stylesheet" href="<?php echo base_url()?>template/assets/vendors/iconfonts/mdi/css/materialdesignicons.min.css">
<link rel="stylesheet" href="<?php echo base_url()?>template/assets/vendors/iconfonts/font-awesome/css/font-awesome.min.css">
...
<link rel="stylesheet" href="<?php echo base_url()?>template/assets/css/demo_1/style.css">
<link rel="shortcut icon" href="<?php echo base_url()?>template/assets/images/favicon.ico" />
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>template/datepicker/src/css/datepicker.css">