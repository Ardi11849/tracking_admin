			...
			<div class="main-panel">
				<div class="content-wrapper">
							...
							<div class="card flex-nowrap">
								<div class="card-body">
									<div class="col-md-12 grid-margin all">
										<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalPengiriman" id="addPenerimaan"><i class="fa fa-plus"></i> Tambah Pengiriman</button>
									</div>
					...
					<div class="row page-title-header">
						<div class="col-12">
							<div class="page-header">
								<h4 class="page-title">Daftar Barang Yang Ada Di Tempat</h4>
							</div>
						</div>
						<div class="col-md-12">
							<div class="page-header-toolbar"></div>
					...
					<div class="row">
						<div class="col-md-12 grid-margin">
							<div class="card flex-nowrap">
								<div class="card-body">
									<table id="myTableFromManifest" class="table table-striped">
										<thead>
											<th>No</th>
											<th>No Resi</th>
											<th>Perusahaan</th>
				...
				<div class="modal-body">
					<form class="forms-sample">
						<div class="form-group">
							<input type="hidden" class="form-control" id="NoResi2" placeholder="No Resi">
						...
						<div class="form-group">
							<label for="NoTelp">Alamat Pengirim</label>
							<textarea class="form-control" id="AlamatPengirim" placeholder="Alamat Pengirim"></textarea>
						</div>
						<div class="form-group">
							<label for="nama">No Telp Pengirim</label>
							<input type="text" class="form-control number" id="NoTelpPengirim" placeholder="No Telp Pengirim">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control number" id="NoTelpPenerima" placeholder="No Telp Penerima">
						</div>
						<div class="separator">Alamat Penerima</div>
						<div class="form-group" id="divKotaBesar">
							<label>KotaBesar</label>
							<select class="form-control" data-live-search="true" data-width="100%" id="KodeKotaBesar">
								<option value = ''>Pilih KotaBesar</option>
								<?php foreach ($kotabesar['data'] as $data) {?>
									<option value="<?php echo $data['KodeKotaBesar'];?>"><?php echo $data["KodeKotaBesar"]." - ".$data["NamaKotaBesar"];?></option>
								<?php } ?>
							</select>
						</div>
						<div class="form-group" id="divKota">
							<label>Kota</label>
							<select class="form-control" data-live-search="true" data-width="100%" id="KodeKota">
								<option value = ''>Pilih Kota</option>
							</select>
						</div>
						<div class="form-group">
							<label for="nama">Detail Alamat</label>
							<textarea class="form-control" id="AlamatPenerima" placeholder="Alamat Penerima"></textarea>
						</div>
						<div class="form-group">
							<label>Sistem Pembayaran</label>
							<select class="form-control" data-live-search="true" data-width="100%" id="SistemPembayaran">
								<option value = ''>Pilih SistemPembayaran</option>
								<option value="1">Pembayaran Di Tempat</option>
								<option value="2">COD</option>
								<option value="3">Pembayaran Nanti</option>
							</select>
						</div>
						<div class="form-group">
							<label for="nama">Berat</label>
							<input type="text" class="form-control berat" id="Berat" placeholder="Berat">
						</div>
						<div class="form-group">
